...
Lomi grabbed a piece of chalk, lunged forward to sketch the aerial arena on the stone balustrade, and slammed his palm against the parapet. "Each city has its own spire, its own harmonic frequency. You build a rig, launch it into the ring, and hit the energy nodes as they light up. You don't know when a spire is going to erupt with power, and when it does, three rigs dive for it simultaneously, scraping hulls and trading paint. You collect the charge, race to the center pillar, and discharge it to score." <!-- L2036 -->

Lomi leaped onto the stone bench, swung his arm out, and grabbed the iron lantern bracket with a wide grin. "One season I climbed the glider launch platform fixing a stuck pneumatic ram. Looking out over that stadium with thirty thousand people screaming... I think folks take to the sky just for the view. It made me queasy, but man, it was a sight to behold. If we build a rig and finish in the top tier, we can write our own ticket." <!-- L2038 --> <!-- L2108 --> <!-- L2117 -->
